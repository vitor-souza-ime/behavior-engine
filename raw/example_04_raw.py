...
# ──────────────────────────────────────────────
# 4. Intermediário — pessoa longe, levanta as mãos (SEM FRAMEWORK)
# ──────────────────────────────────────────────
...
try:
    while True:
        ...
        for box in results.boxes:
            ...
            if distance is not None and distance > FAR_THRESHOLD_METERS:
                person_far = True
                break

        current_time = time.time()
        if person_far and (current_time - last_action_time) > COOLDOWN:
