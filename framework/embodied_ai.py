...
class EmbodiedAI:
    ...
    Uso:
        ...
        distance = robot.object_distance("person")
        # 1.42  (metres)
    """
    ...
    def detect_with_distance(
        ...
        detection with the depth-camera distance.
    ...
    def squat_to_standup(self) -> None:
        """Transição de agachado para em pé."""
        self._loco.Damp()
        time.sleep(0.5)
    ...
    def lie_to_standup(self) -> None:
        ...
        ATENÇÃO: o robô deve estar de barriga para cima,
        sobre superfície dura, plana e antiderrapante.
        """
        self._loco.Damp()
        time.sleep(0.5)
    ...
    def wave_hand(self, turn_around: bool = False) -> None:
        ...
        Args:
            turn_around: Se True, acena girando o corpo.
        """
